...
Firstly, have a look at the **available papers**. and then form into teams. 
...
#### What to do
  ...
  - **[Create user accounts](https://www.reprohack.org/accounts/signup/)** on the Hub for all reviewers that want to be associated with the review.
